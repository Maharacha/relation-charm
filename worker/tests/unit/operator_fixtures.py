...
# -*- coding: utf-8 -*-
# vim:fenc=utf-8
# Copyright © 2020 Joakim Nyman joakim.nyman86@gmail.com
...
import ops
import ops.main
from src.charm import WorkerCharm
...
class OperatorTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        charm = WorkerCharm(framework, None)
        self.charm = charm
    ...
    def get_notice_count(self, hook):
        ...
        notice_count = 0
        handle = "WorkerCharm/on/{}".format(hook)
